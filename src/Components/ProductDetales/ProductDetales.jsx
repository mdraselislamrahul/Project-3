  ...
  return (
    <div className="mt-10 md:flex">
      ...
      className="mt-10 md:w-1/2">
        ...
        <h2 className="mt-8 text-2xl font-bold text-red-600">Total Proce: ${pricecount}</h2>
        <div className="flex mt-10">
          ...
          <p>Availability:  <span className="ml-5 text-green-500">{availability}</span>
            </p>
            <p>Vendor:   <span className="ml-14">{vendor}</span></p>
            <p>Categories:    <span className="ml-6">{categories[0]}, {categories[1]}</span>
            </p>
            <p>Tags: <span className="ml-20">{tags[0]}, {tags[1]}, {tags[2]}, {tags[3]}</span>
            </p>
          </div>
      </div>
    </div>
